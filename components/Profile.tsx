        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-xl font-black text-text-main tracking-tight">Mi Perfil</h3>
                        <p className="text-[11px] text-text-muted font-bold opacity-60">Gestiona tu información personal y seguridad</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-surface/50 backdrop-blur-xl border border-white/5 rounded-[1.5rem] p-6 shadow-2xl relative overflow-hidden group">
                        <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />

                        <div className="flex flex-col items-center text-center">
                            <div className="relative w-32 h-32 mb-4 group/avatar">
                                <div className="w-full h-full rounded-[2rem] bg-input-bg border-4 border-surface shadow-2xl overflow-hidden flex items-center justify-center relative">
                                    {currentUser.avatar ? (
                            ...
                            <h2 className="text-lg font-black text-text-main tracking-tight">{currentUser.name}</h2>
                            <p className="text-xs font-bold text-text-muted opacity-60 mb-2">@{currentUser.username}</p>
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-surface/30 backdrop-blur-xl border border-white/5 rounded-[1.5rem] p-6 shadow-sm">
                        ...
                        <form onSubmit={handleUpdateProfile} className="space-y-4">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-input-bg border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-xs font-bold text-text-main outline-none focus:border-primary shadow-inner transition-all"
                                            placeholder="+51..."
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            disabled
                                            className="w-full bg-black/5 border border-white/5 rounded-xl pl-10 pr-4 py-2.5 text-xs font-bold text-text-muted outline-none cursor-not-allowed shadow-inner"
                                        />
                                    </div>
                            ...
                            <div className="flex justify-end pt-2">
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="bg-primary hover:bg-primary/90 text-white px-6 py-2 rounded-xl flex items-center gap-2 text-[11px] font-bold shadow-lg shadow-primary/20 transition-all active:scale-95 disabled:opacity-50"
                                >
                        ...
                        <form onSubmit={handleChangePassword} className="space-y-4">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    className="w-full bg-input-bg border border-white/10 rounded-xl px-4 py-2.5 text-xs font-bold text-text-main outline-none focus:border-secondary shadow-inner transition-all"
                                    placeholder="••••••"
                                />
                            </div>
                            ...
                            <div className="flex justify-end pt-2">
                                <button
                                    ...
                                    className="bg-secondary hover:bg-secondary/90 text-white px-6 py-2 rounded-xl flex items-center gap-2 text-[11px] font-bold shadow-lg shadow-secondary/20 transition-all active:scale-95 disabled:opacity-50"
                                >
